...
export var colourOptions = [
    ...
    {
        value: "long-test",
        label: "This is an extremely long label which is used for testing purposes. It may be too long to fit in a single line, but this is exactly what we want here as we want to test overflow handling",
        color: "#666666",
        type: "Other",
        icon: "https://via.placeholder.com/512",
    },
];
export var flavourOptions = [
    { value: "vanilla", label: "Vanilla", rating: "safe" },
    { value: "chocolate", label: "Chocolate", rating: "good" },
    { value: "strawberry", label: "Strawberry", rating: "wild" },
    { value: "salted-caramel", label: "Salted Caramel", rating: "crazy" },
];
export var stateOptions = [
