...
export var TextAreaWithHelpStory = function () {
    ...
    return (React.createElement(TextFieldWithHelp, { label: text("Label", "FieldName"), placeholder: text("Placeholder", "Enter something here"), fullWidth: boolean("100% Width", true), important: boolean("Important", false), variant: "outlined", multiline: true, openInfo: function () {
