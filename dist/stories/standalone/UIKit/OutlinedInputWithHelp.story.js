...
export var OutlinedInputWithHelpStory = function () {
    ...
    return (React.createElement(OutlinedInputWithHelp, { placeholder: text("Placeholder", "Enter something here"), fullWidth: boolean("100% Width", true), important: boolean("Important", false), openInfo: function () {
