...
export var NotificationsStory = function () {
    return (React.createElement(Notifications, { loadRead: action("loadRead"), loadUnread: action("loadUnread"), loadLatest: action("loadLatest"), onOpen: action("onOpen"), notifications: [
            {
                id: "1",
