 ...
 */
declare const generateLocalizedExcelImportTemplate: <KeyT extends ModelFieldName, VisibilityT extends PageVisibility, CustomT>(model: Model<KeyT, VisibilityT, CustomT>, fields: KeyT[], fileName: string) => File;
