 ...
 */
var processImageB64 = function (imageData, convertImagesTo, downscale) { return __awaiter(void 0, void 0, void 0, function () {
    var image, newWidth, newHeight, downscaleRatio, canvas, ctx;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, new Promise(function (resolve, reject) {
                        ...
                        image.addEventListener("error", function (evt) { return reject(evt.error); });
                        image.src = imageData;
                    })];
            case 1:
                _a.sent();
                ...
                if (downscale &&
                    ...
                    if (!downscale.keepRatio) {
                        ...
                        downscaleRatio = Math.max(image.width / downscale.width, image.height / downscale.height);
                ...
                return [2 /*return*/, canvas.toDataURL(convertImagesTo)];
        }
    });
}); };
