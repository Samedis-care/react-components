 ...
 */
export declare const useModelGet: <KeyT extends string, VisibilityT extends PageVisibility, CustomT>(model: Model<KeyT, VisibilityT, CustomT>, id: string | null) => UseQueryResult<ModelGetResponse<KeyT>, Error>;
/**
