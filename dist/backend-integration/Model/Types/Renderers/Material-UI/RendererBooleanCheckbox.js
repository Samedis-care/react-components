...
var RendererBooleanCheckbox = /** @class */ (function (_super) {
    ...
    RendererBooleanCheckbox.prototype.render = function (params) {
        ...
        if (visibility.editable) {
            ...
            return visibility.grid ? (control) : (React.createElement(FormControlFieldsetCC, { required: visibility.required, error: !!errorMsg, warning: !!warningMsg, component: "fieldset" },
