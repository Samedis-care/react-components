...
class RendererString extends TypeString {
    ...
    render(params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(TextFieldCC, { variant: this.multiline ? "outlined" : undefined, fullWidth: true, ...this.props, name: field, value: value ?? "", label: label, disabled: visibility.readOnly, required: visibility.required, onChange: (evt) => {
