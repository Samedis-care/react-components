 ...
 */
var RendererDecimal = /** @class */ (function (_super) {
    __extends(RendererDecimal, _super);
    function RendererDecimal(props) {
        var _this = _super.call(this) || this;
        _this.props = props;
        return _this;
    }
    RendererDecimal.prototype.render = function (params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(DecimalInputField, __assign({ fullWidth: true }, this.props, { name: field, value: value, label: label, disabled: visibility.readOnly, required: visibility.required, onChange: function (evt, value) {
