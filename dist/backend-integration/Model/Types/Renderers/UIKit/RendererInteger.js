...
class RendererInteger extends TypeNumber {
    ...
    render(params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(IntegerInputField, { fullWidth: true, ...this.props, name: field, value: value, label: label, disabled: visibility.readOnly, required: visibility.required, onChange: (evt, value) => {
