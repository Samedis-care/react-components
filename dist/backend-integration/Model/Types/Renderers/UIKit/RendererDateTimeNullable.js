...
var RendererDateTimeNullable = /** @class */ (function (_super) {
    ...
    RendererDateTimeNullable.prototype.render = function (params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(DateTimeInput, { value: value ? moment(value) : null, label: label, disabled: visibility.readOnly, required: visibility.required, onChange: function (date) {
