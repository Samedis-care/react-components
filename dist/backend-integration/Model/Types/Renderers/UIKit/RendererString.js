...
var RendererString = /** @class */ (function (_super) {
    ...
    RendererString.prototype.render = function (params) {
        ...
        if (visibility.hidden) {
            return (React.createElement("input", { type: "hidden", name: field, value: value !== null && value !== void 0 ? value : "", readOnly: true, "aria-hidden": "true" }));
        }
        if (visibility.editable) {
            if (visibility.grid)
                throw new Error("Not supported");
            return (React.createElement(React.Fragment, null,
                React.createElement(TextFieldWithHelp, __assign({ variant: this.multiline ? "outlined" : undefined, fullWidth: true }, this.props, { name: field, value: value !== null && value !== void 0 ? value : "", label: label, disabled: visibility.readOnly, required: visibility.required, onChange: function (evt) {
