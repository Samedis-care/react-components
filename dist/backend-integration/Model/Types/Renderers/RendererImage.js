        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(ImageSelector, { name: field, value: value, label: label, readOnly: visibility.readOnly, onChange: (name, value) => {
                    ...
                    }, onBlur: handleBlur, alt: label, capture: this.params?.capture ?? false, uploadLabel: this.params?.uploadLabel, convertImagesTo: this.params?.convertImagesTo, downscale: this.params?.downscale, variant: this.params?.variant }),
