...
var RendererBackendSingleSelect = /** @class */ (function (_super) {
    ...
    RendererBackendSingleSelect.prototype.render = function (params) {
        var visibility = params.visibility, field = params.field, value = params.value, label = params.label, handleChange = params.handleChange, handleBlur = params.handleBlur, errorMsg = params.errorMsg, warningMsg = params.warningMsg, relationData = params.relationData, relationModel = params.relationModel;
