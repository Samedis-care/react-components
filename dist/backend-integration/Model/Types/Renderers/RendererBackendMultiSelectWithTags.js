 ...
 */
var RendererBackendMultiSelectWithTags = /** @class */ (function (_super) {
    __extends(RendererBackendMultiSelectWithTags, _super);
    function RendererBackendMultiSelectWithTags(props) {
        var _this = _super.call(this) || this;
        _this.props = props;
        return _this;
    }
    RendererBackendMultiSelectWithTags.prototype.render = function (params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(FormControlFieldsetCC, { component: "fieldset", required: visibility.required, fullWidth: true, error: !!errorMsg, warning: !!warningMsg, onBlur: handleBlur, name: field },
                React.createElement(BackendMultiSelectWithTags, __assign({ selected: value, onChange: function (value) { return handleChange(field, value); }, disabled: visibility.readOnly, dataModel: relationModel, initialData: relationData, title: label }, this.props)),
                React.createElement(FormHelperText, null, errorMsg || warningMsg)));
        }
        throw new Error("view-only rendering not supported");
    };
    return RendererBackendMultiSelectWithTags;
}(TypeStringArray));
