...
export declare const FormBackendSingleSelect: <KeyT extends ModelFieldName, VisibilityT extends PageVisibility, CustomT>(props: FormBackendSingleSelectProps<KeyT, VisibilityT, CustomT>) => import("react/jsx-runtime").JSX.Element;
...
export declare const FormBackendMultiSelect: <KeyT extends ModelFieldName, VisibilityT extends PageVisibility, CustomT, DataT extends MultiSelectorData>(props: FormBackendMultiSelectProps<KeyT, VisibilityT, CustomT, DataT>) => import("react/jsx-runtime").JSX.Element;
export {};
