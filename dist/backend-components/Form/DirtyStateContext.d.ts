 ...
 */
export declare const NO_DIRTY_STATE: DirtyStateMarks;
/**
 ...
 */
export declare const DirtyStateContext: React.Context<DirtyStateMarks>;
/**
 * Gets the fields which display the modified marker
 * @see DirtyStateContext
 */
export declare function useDirtyState(): DirtyStateMarks;
/**
 ...
 * @see DirtyStateContext
 */
export declare function useDirtyState(field: string): boolean;
