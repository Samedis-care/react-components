...
var CollapsibleMenu = function (props) {
    ...
    return (React.createElement(Grid, { container: true, justify: "flex-start", alignItems: "stretch", wrap: "nowrap", style: collapsed ? { overflow: "visible" } : undefined, className: combineClassNames([
            classes.container,
        ...
        !mobile && (React.createElement(Grid, { item: true, key: "bar", className: classes.bar },
            React.createElement(IconButton, { onClick: toggleCollapsed, className: (_b = props.customClasses) === null || _b === void 0 ? void 0 : _b.button },
