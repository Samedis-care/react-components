...
const MultiSelectWithTags = (inProps) => {
    ...
    const { title, dirty, searchInputLabel, selected, disabled, autocompleteId, enableIcons, noOptionsText, loadingText, openText, closeText, forceQuery, startTypingToSearchText, loadGroupEntries, loadGroupOptions, loadDataOptions, onChange, openInfo, getIdOfData, switchLabel, lruGroup, lruData, sortCompareFn, className, classes, filterIds, } = props;
    ...
    return (_jsxs(Root, { className: combineClassNames([className, classes?.root]), children: [_jsx(LoadOverlay, { className: classes?.loadOverlay, style: loadingGroupRecords
                    ...
                    : { visibility: "hidden", opacity: 0 }, children: _jsx(Loader, {}) }), _jsx(Typography, { component: "label", variant: "caption", color: "textSecondary", children: labelWithDirtyMarker(title, dirty) }), _jsx(SingleSelect, { autocompleteId: autocompleteId ? autocompleteId + "-group-select" : undefined, selected: null, onSelect: handleGroupSelect, refreshToken: selectedGroups.length.toString(), onLoad: loadGroupOptionsAndProcess, disabled: disabled || loadingGroupRecords, enableIcons: enableIcons, noOptionsText: noOptionsText, loadingText: loadingText, openText: openText, closeText: closeText, forceQuery: forceQuery, startTypingToSearchText: startTypingToSearchText, lru: lruGroup }), _jsx(Box, { sx: { pt: 3 }, children: _jsx(MultiSelectWithoutGroup, { autocompleteId: autocompleteId, selected: selected, disabled: disabled, label: searchInputLabel, enableIcons: enableIcons, switchValue: switchValue, setSwitchValue: setSwitchValue, switchLabel: switchLabel, displaySwitch: props.displaySwitch, loadDataOptions: loadDataOptions, openInfo: openInfo, onSelect: onChange, getIdOfData: getId, noOptionsText: noOptionsText, loadingText: loadingText, forceQuery: forceQuery, startTypingToSearchText: startTypingToSearchText, lru: lruData, sortCompareFn: sortCompareFn, filterIds: filterIds }) })] }));
};
