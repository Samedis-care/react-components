...
import { ListItemText, IconButton, InputLabel, Paper, Divider, Typography, Popper, Grid, } from "@material-ui/core";
import { Autocomplete } from "@material-ui/lab";
import { Add as AddIcon, ExpandMore, Info as InfoIcon, } from "@material-ui/icons";
import { cleanClassMap, combineClassNames, SelectorSmallListItem, SmallListItemIcon, useLocalStorageState, } from "../..";
...
export var getStringLabel = function (data) {
    return typeof data.label === "string" ? data.label : data.label[0];
};
...
var useCustomStylesBase = makeStyles(function (theme) { return ({
    ...
    selected: {
        ...
        padding: "".concat(theme.spacing(1) / 2, "px ").concat(theme.spacing(1), "px"),
    },
    divider: {
        width: "100%",
    },
...
var BaseSelector = function (props) {
    ...
    var defaultRenderer = useCallback(function (data) {
        ...
        if (data.isSmallLabel)
            return (React.createElement(Typography, { variant: "caption", className: customClasses.smallLabel }, getReactLabel(data)));
            ...
            React.createElement(Paper, { elevation: 0, className: customClasses.wrapper },
                React.createElement(Autocomplete, { id: autocompleteId, classes: classes, open: open, onOpen: function () {
                    ...
                    selected &&
                        ...
                        return (React.createElement(InputComponent, __assign({ readOnly: disableSearch }, InputProps, otherParams, { inputProps: __assign(__assign({}, params.inputProps), { title: selected ? getStringLabel(selected) : undefined }), startAdornment: (_a = (enableIcons ? renderIcon(selected === null || selected === void 0 ? void 0 : selected.icon) : undefined)) !== null && _a !== void 0 ? _a : startAdornment, endAdornment: (function () {
                                var _a, _b, _c;
