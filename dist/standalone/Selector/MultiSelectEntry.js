...
import { Divider, List, ListItemSecondaryAction, ListItemText, makeStyles, } from "@material-ui/core";
...
var MultiSelectEntry = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(List, { className: combineClassNames([classes.root, classes.container]) },
            React.createElement(SmallListItem, { button: true, onClick: data.onClick, className: combineClassNames([
                    classes.selected,
