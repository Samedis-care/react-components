...
export declare const getStringLabel: (data: BaseSelectorData) => string;
...
declare const useCustomStylesBase: (props: Pick<BaseSelectorProps<BaseSelectorData>, "label" | "iconSize">) => import("@material-ui/styles/withStyles/withStyles").ClassNameMap<"switch" | "selected" | "icon" | "wrapper" | "divider" | "smallLabel" | "labelWithSwitch" | "infoBtn" | "textFieldStandard" | "listItem" | "lruListItem">;
