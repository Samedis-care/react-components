...
import { Star as StarredIcon, StarOutline as NotStarredIcon, } from "@material-ui/icons";
...
var ImageDialogEntry = function (props) {
    ...
    return (React.createElement(Grid, { item: true, xs: previewSize ? undefined : 12, md: previewSize ? undefined : 6, lg: previewSize ? undefined : 3 },
        ...
        React.createElement(Box, { mt: 1 },
            React.createElement(Grid, { container: true, spacing: 1, alignItems: "center", justify: "flex-start", className: isPrimary ? undefined : classes.clickable, onClick: isPrimary ? undefined : setPrimary },
