...
var TextFieldWithHelp = React.forwardRef(function TextFieldWithHelpInner(props, ref) {
    ...
    // handle clear
    var _f = useState(!!((_a = muiProps.value) !== null && _a !== void 0 ? _a : muiProps.defaultValue)), hasValue = _f[0], setHasValue = _f[1];
    var composeRef = useRefComposer();
            ...
            muiProps.className,
                ...
                React.createElement(InputAdornment, { position: "end" },
                    ...
                    openInfo && (React.createElement(IconButton, { onClick: openInfo, size: "large" },
                        React.createElement(InfoIcon, { color: "disabled" })))))) }), inputProps: __assign(__assign({}, muiProps.inputProps), { ref: composeRef(inputRef, (_e = muiProps.inputProps) === null || _e === void 0 ? void 0 : _e.ref) }) })));
});
