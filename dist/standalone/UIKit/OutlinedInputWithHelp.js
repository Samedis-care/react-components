...
var OutlinedInputWithHelpInner = function (props, ref) {
    ...
    return (React.createElement(OutlinedInput, __assign({ ref: ref, classes: inputClasses, endAdornment: openInfo && (React.createElement(InputAdornment, { position: "end" },
            React.createElement(IconButton, { onClick: openInfo },
                React.createElement(InfoIcon, { color: "disabled" })))) }, muiProps)));
};
var OutlinedInputWithHelp = React.forwardRef(OutlinedInputWithHelpInner);
