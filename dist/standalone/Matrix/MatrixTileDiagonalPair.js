...
import { contrastTextFor, dimColor, MATRIX_TILE_DIM_OPACITY, } from "./matrixTileDim";
...
export const MatrixTileDiagonalRoot = styled("div", {
    ...
    overflow: "hidden",
    background: `linear-gradient(to bottom right, ${cssVar(matrixVars.tileBackgroundA)} 0 49.5%, ${cssVar(matrixVars.tileBackgroundB)} 50.5% 100%)`,
...
const DIAGONAL_CORNERS = ["bottomLeft"];
/**
 ...
 */
const MatrixTileDiagonalPair = (props) => {
    const { a, b } = props;
    ...
    const style = useMemo(() => ({
        ...
        [matrixVars.tileBackgroundB]: b.dimmed
            ...
            : b.backgroundColor,
        [matrixVars.tileForegroundA]: a.textColor ?? contrastTextFor(theme, a.backgroundColor),
        [matrixVars.tileForegroundB]: b.textColor ?? contrastTextFor(theme, b.backgroundColor),
    }), [
        theme,
        a.dimmed,
        a.backgroundColor,
    ...
    const pair = (_jsxs(MatrixTileDiagonalRoot, { className: combineClassNames([
            classes?.diagonal,
            onItemClick && matrixClasses.itemClickable,
        ]), style: style, ...activation, onMouseDown: onItemClick ? handleMouseDown : undefined, children: [_jsx(MatrixTileDiagonalLabel, { className: combineClassNames([
                    classes?.diagonalLabel,
                    matrixClasses.diagonalLabelStart,
                    a.dimmed && matrixClasses.diagonalLabelDimmed,
                ]), children: a.label }), _jsx(MatrixTileDiagonalLabel, { className: combineClassNames([
                    classes?.diagonalLabel,
                    matrixClasses.diagonalLabelEnd,
                    b.dimmed && matrixClasses.diagonalLabelDimmed,
                ]), children: b.label }), _jsx(MatrixTileCorners, { item: a, only: DIAGONAL_CORNERS, className: classes?.corner })] }));
    return tooltip ? (_jsx(Tooltip, { title: tooltip, enterDelay: 400, children: pair })) : (pair);
};
