...
import { MatrixCellContext, MatrixColumn, MatrixExtraRow, MatrixRangeSelection, MatrixRow, MatrixRowHeaderContext } from "./types";
export type MatrixGridClassKey = "root" | "grid" | "corner" | "columnHeader" | "columnHeaderLabel" | "columnHeaderSubLabel" | "rowHeader" | "cell" | "addHint" | "addChip" | "extraRowHeader" | "extraCell" | "badge" | "extraCellAddHint";
export interface MatrixGridProps<TCell> {
     ...
     */
    renderRowHeader: (row: MatrixRow<TCell>, context: MatrixRowHeaderContext) => React.ReactNode;
    /**
     ...
     */
    renderCell: (cell: TCell | undefined, context: MatrixCellContext<TCell>) => React.ReactNode;
    /**
     ...
     */
    renderCellWrapper?: (node: React.ReactNode, context: MatrixCellContext<TCell>) => React.ReactNode;
    /**
     ...
     */
    isCellSelectable?: (cell: TCell | undefined, context: MatrixCellContext<TCell>) => boolean;
    /**
     ...
     */
    isCellOccupied?: (cell: TCell | undefined, context: MatrixCellContext<TCell>) => boolean;
    /**
...
export declare const defaultIsCellSelectable: (cell: unknown) => boolean;
export declare const defaultIsCellOccupied: (cell: unknown) => boolean;
/**
 ...
 */
export declare const isCellSelectableIn: <TCell>(config: MatrixGridConfig<TCell>, row: MatrixRow<TCell>, column: MatrixColumn, columnIndex: number) => boolean;
export declare const MatrixConfigContext: React.Context<MatrixGridConfig<unknown> | undefined>;
export declare const useMatrixConfig: <TCell>() => MatrixGridConfig<TCell>;
