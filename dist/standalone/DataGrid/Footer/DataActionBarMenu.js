...
var DataActionBarMenu = function (props) {
    ...
    return (React.createElement(PopupMenu, { elevation: 0, anchorEl: anchorEl, anchorOrigin: anchorOrigin, transformOrigin: transformOrigin, keepMounted: true, open: !!anchorEl, onClose: onClose }, customButtons.map(function (entry) { return (React.createElement(MenuItem, { key: entry.label, disabled: entry.isDisabled(numSelected), onClick: function () {
