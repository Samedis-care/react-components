...
import { Checkbox, Divider, FormControlLabel, Grid, IconButton, List, ListItem, ListItemText, MenuItem, Select, TextField, Tooltip, } from "@material-ui/core";
...
var FilterEntry = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        (props.valueType === "string" ||
            ...
            filterType !== "empty" && filterType !== "notEmpty" && (React.createElement(Grid, { item: true, xs: 12 }, props.valueType === "date" ? (React.createElement(LocalizedKeyboardDatePicker, { value: filterValue === "" ? null : filterValue, onChange: onFilterValueChangeDate, fullWidth: true, autoFocus: depth === 1 })) : props.valueType === "datetime" ? (React.createElement(LocalizedDateTimePicker, { value: filterValue === "" ? null : filterValue, onChange: onFilterValueChangeDate, fullWidth: true, autoFocus: depth === 1 })) : (React.createElement(TextField, { value: filterValue, onChange: onFilterValueChange, fullWidth: true, autoFocus: depth === 1 })))),
            filterType === "inRange" && (React.createElement(Grid, { item: true, xs: 12 }, props.valueType === "date" ? (React.createElement(LocalizedKeyboardDatePicker, { value: filterValue2 === "" ? null : filterValue2, onChange: onFilterValue2ChangeDate, fullWidth: true })) : props.valueType === "datetime" ? (React.createElement(LocalizedDateTimePicker, { value: filterValue === "" ? null : filterValue, onChange: onFilterValueChangeDate, fullWidth: true })) : (React.createElement(TextField, { value: filterValue2, onChange: onFilterValue2Change, fullWidth: true })))))),
                ...
                React.createElement(List, null,
                    ...
                    props.valueData
                        ...
                        .map(function (entry) { return (React.createElement(ListItem, { key: entry.value, className: entry.isDivider
                            ...
                            : classes.setFilterListItem, disabled: entry.disabled || entry.isDivider }, entry.isDivider ? (React.createElement(Divider, { className: classes.setFilterListDivider })) : (React.createElement(React.Fragment, null,
