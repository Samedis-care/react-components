...
var DataGrid = function (props) {
    ...
    return (React.createElement(Grid, { container: true, direction: "column", justify: "space-between", alignItems: "stretch", wrap: "nowrap", className: classes.wrapper, ref: function (r) { return (gridRoot.current = r ? r : undefined); } },
