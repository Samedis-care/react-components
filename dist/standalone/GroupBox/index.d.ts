...
export declare type GroupBoxClassKey = keyof ReturnType<typeof useStylesBase>;
export declare type GroupBoxTheme = Partial<Styles<Theme, GroupBoxProps, GroupBoxClassKey>>;
