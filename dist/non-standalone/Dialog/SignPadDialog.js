...
import { Button, Dialog, DialogActions, makeStyles, IconButton, Typography, } from "@material-ui/core";
...
var SignPadDialog = function (props) {
    ...
    return (React.createElement(Dialog, { open: true, maxWidth: "sm", disableBackdropClick: true, onClose: closeCanvas },
        React.createElement(MuiDialogTitle, { id: "sign-pad-dialog", disableTypography: true, className: classes.root },
            React.createElement(Typography, { variant: "h6" }, t("standalone.signature-pad.dialog.title")),
            closeCanvas && (React.createElement(IconButton, { "aria-label": "Close", className: classes.closeButton, onClick: closeCanvas },
